...
std::tuple<at::Tensor, at::Tensor, at::Tensor, at::Tensor> mha_fwd(
    ...
    int64_t protection_page_table_expected_mapping_offset,
    int64_t protection_page_table_2_expected_mapping_offset,
    ...
    std::optional<at::Tensor> protection_expected_physical_pages_,
