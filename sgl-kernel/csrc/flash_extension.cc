...
TORCH_LIBRARY_FRAGMENT(sgl_kernel, m) {
  ...
  m.def(
      ...
      "    int      protection_page_table_expected_mapping_offset,"
      "    int      protection_page_table_2_expected_mapping_offset,"
      ...
      "    Tensor?  protection_expected_physical_pages,"
      "    int      protection_expected_mapping_stride,"
      "    int      protection_expected_mapping_namespace_stride,"
