...
def flash_attn_with_kvcache(
    ...
    out, softmax_lse, *rest = torch.ops.sgl_kernel.fwd.default(
        ...
        protection.get("expected_physical_pages"),
        protection.get("expected_mapping_stride", 0),
        protection.get("expected_mapping_namespace_stride", 0),
...
def flash_attn_varlen_func(
    ...
    out, softmax_lse, *rest = torch.ops.sgl_kernel.fwd.default(
        ...
        protection_page_table_expected_mapping_offset=0,
        protection_page_table_2_expected_mapping_offset=0,
        ...
        protection_expected_physical_pages=None,
        protection_expected_mapping_stride=0,
        protection_expected_mapping_namespace_stride=0,
