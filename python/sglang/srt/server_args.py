...
class ServerArgs:
    ...
    marconi_tuning_interval: int = DEFAULT_MARCONI_TUNING_INTERVAL
    ...
    def _handle_cache_compatibility(self):
        ...
        if self.enable_marconi_admission():
            get_marconi_branch_align_interval(
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            help="Weight for FLOP efficiency in Marconi eviction utility when --radix-eviction-policy=marconi.",
        )
        parser.add_argument(
            "--disable-marconi-autotune",
            action="store_true",
            help="Disable Marconi eviction autotuning and keep --marconi-eff-weight fixed.",
        )
        parser.add_argument(
            "--marconi-bootstrap-multiplier",
            type=int,
            default=ServerArgs.marconi_bootstrap_multiplier,
            help="Bootstrap window multiplier used after the first Marconi eviction.",
        )
        parser.add_argument(
            "--marconi-tuning-interval",
            type=int,
            default=ServerArgs.marconi_tuning_interval,
            help="Number of completed requests between Marconi tuning attempts after bootstrap.",
        )
        parser.add_argument(
