...
from sglang.srt.models.deepseek.attention_methods.forward_mha import ForwardMHAMixin
from sglang.srt.models.deepseek.attention_methods.forward_mla import ForwardMLAMixin
from sglang.srt.models.deepseek.attention_methods.forward_mla_cpu import (
    ForwardMLACpuMixin,
)
from sglang.srt.models.deepseek.attention_methods.forward_mla_rocm import (
    ForwardMLARocmMixin,
)
from sglang.srt.models.deepseek.hardware_backend.deepseek_v2_amd_mixin import (
    DeepseekV2AmdMixin,
)
from sglang.srt.models.deepseek.hardware_backend.deepseek_v2_cpu_mixin import (
    DeepseekV2CpuMixin,
)
from sglang.srt.models.deepseek.hardware_backend.deepseek_v2_npu_mixin import (
    DeepseekV2NPUMixin,
)
...
from sglang.srt.models.deepseek.v32_mixin import DeepseekV32Mixin
...
class DeepseekV2AttentionMLA(
    ...
    def forward_prepare(
        ...
        if attn_forward_method == AttnForwardMethod.MHA:
            ...
            inner_state = self.forward_mha_prepare_npu(
                positions, hidden_states, forward_batch, zero_allocator
            )
        elif attn_forward_method == AttnForwardMethod.MLA_NPU:
            inner_state = self.forward_mla_prepare_npu(
                positions, hidden_states, forward_batch, zero_allocator
            )
        elif attn_forward_method == AttnForwardMethod.DSA_NPU:
            inner_state = self.forward_dsa_prepare_npu(
                positions, hidden_states, forward_batch, zero_allocator
            )
        else:
    ...
    def forward_core(self, intermediate_state):
        ...
        if attn_forward_method == AttnForwardMethod.MHA:
            ...
            return self.forward_mha_core_npu(*inner_state)
        elif attn_forward_method == AttnForwardMethod.MLA_NPU:
            return self.forward_mla_core_npu(*inner_state)
        elif attn_forward_method == AttnForwardMethod.DSA_NPU:
            return self.forward_dsa_core_npu(*inner_state)
        else:
            raise NotImplementedError
...
class DeepseekV2ForCausalLM(DeepseekV2WeightLoaderMixin, DeepseekV32Mixin, nn.Module):
    ...
    def forward(
        ...
        self.prepare_cp_metadata(input_ids, forward_batch)
